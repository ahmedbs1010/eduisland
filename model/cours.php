...
/************insertion******************* */
    public function createcours( $matiere, $niveau, $nbheure, $idt) {
        $sql = "INSERT INTO lessons ( matiere, niveau, nbheure, idt) 
                VALUES (  ?, ?, ?, ?)";
        $stmt = $this->conn->prepare($sql);
    $stmt->bind_param('ssii',  $matiere, $niveau, $nbheure, $idt);
...
/**********update*************** */
    public function updatecours($idlesson, $matiere,$nbheure, $niveau,  $idt) {
        ...
        if ($check_stmt->num_rows > 0) {
            ...
            $update_stmt->bind_param('sisii', $matiere, $nbheure, $niveau,  $idt, $idlesson);
